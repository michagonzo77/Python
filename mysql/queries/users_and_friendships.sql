INSERT into users (first_name, last_name) VALUES ("Amy", "Giver"), ("Eli", "Byers"), ("Big", "Bird"), ("Kermit", "The Frog"), ("Marky", "Mark"), ("Mickey", "Mouse");
SELECT * from users;
...
SELECT *, COUNT(friendships.id) AS friendships FROM friendships;
